...
$$
  ...
  - Should be a two-tailed test if default `lm` output is used later
...
# critical value is the 95th percentile of the t dist w/ n-1 degrees of freedom
tcrit <- qt(p = .95, df = nrow(HousePrices) - 1) 
```
